...
whisper_model = whisperx.load_model("large-v2", device=DEVICE, compute_type=WHISPER_COMPUTE_TYPE)
...
def transcribe_video(input_video):
    ...
    result = whisperx.align(result["segments"], model_a, metadata, audio, WHISPER_COMPUTE_TYPE,
